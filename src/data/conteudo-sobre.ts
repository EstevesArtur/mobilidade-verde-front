...
export const STACK: ItemValor[] = [
  ...
  { icone: "♿", titulo: "Acessibilidade", descricao: "Navegação completa por teclado com foco visível, aria-label nos controles, aria-expanded no menu e no acordeão, e respeito a prefers-reduced-motion." },
];
