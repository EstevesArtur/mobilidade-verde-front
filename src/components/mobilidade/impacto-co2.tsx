...
export function ImpactoCo2({ impacto }: ImpactoCo2Props) {
  return (
    <section
      ...
      className="grid grid-cols-2 gap-6 rounded-grande bg-soul-100 p-8 text-center"
    >
      <div>
        <p className="font-display text-4xl font-extrabold text-soul-700">
      ...
      <p className="col-span-2 border-t border-soul-300 pt-4 text-xs text-grafite-500">
