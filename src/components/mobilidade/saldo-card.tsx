...
export function SaldoCard({ nome, saldo }: SaldoCardProps) {
  return (
    <article className="rounded-grande bg-gradient-to-br from-soul-900 to-soul-600 px-12 py-16 text-white shadow-alta">
      <p className="text-sm tracking-[0.06em] uppercase opacity-[0.78]">
        Olá, {nome.split(" ")[0]} · saldo Pontos ECOA
      </p>
      <p className="font-display mt-2 mb-1 text-[4rem] leading-[1.05] font-extrabold">
